...
public class QiyeController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		QiyeEntity user = qiyeService.selectOne(new EntityWrapper<QiyeEntity>().eq("qiyemingcheng", username));
    ...
    public R register(@RequestBody QiyeEntity qiye){
    	...
    	QiyeEntity user = qiyeService.selectOne(new EntityWrapper<QiyeEntity>().eq("qiyemingcheng", qiye.getQiyemingcheng()));
		if(user!=null) {
