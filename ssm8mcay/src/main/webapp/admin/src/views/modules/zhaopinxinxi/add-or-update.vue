<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.gongzuohuanjing" label="工作环境" prop="gongzuohuanjing">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.gongzuohuanjing.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="岗位薪酬" prop="gangweixinchou">
          <el-input v-model="ruleForm.gangweixinchou" 
              placeholder="岗位薪酬" clearable  :readonly="ro.gangweixinchou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="岗位薪酬" prop="gangweixinchou">
              <el-input v-model="ruleForm.gangweixinchou" 
                placeholder="岗位薪酬" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="福利待遇" prop="fulidaiyu">
          <el-input v-model="ruleForm.fulidaiyu" 
              placeholder="福利待遇" clearable  :readonly="ro.fulidaiyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="福利待遇" prop="fulidaiyu">
              <el-input v-model="ruleForm.fulidaiyu" 
                placeholder="福利待遇" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公司电话" prop="gongsidianhua">
          <el-input v-model="ruleForm.gongsidianhua" 
              placeholder="公司电话" clearable  :readonly="ro.gongsidianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公司电话" prop="gongsidianhua">
              <el-input v-model="ruleForm.gongsidianhua" 
                placeholder="公司电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	userid : false,
      ...
      rules: {
          ...
          gangweixinchou: [
                { required: true, message: '岗位薪酬不能为空', trigger: 'blur' },
          ],
          fulidaiyu: [
                { required: true, message: '福利待遇不能为空', trigger: 'blur' },
          ],
          gongzuoshijian: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gangweiyaoqiu = true;
          ...
          if(o=='gangweixinchou'){
            this.ruleForm.gangweixinchou = obj[o];
	    this.ro.gangweixinchou = true;
            continue;
          }
          if(o=='fulidaiyu'){
      ...
      this.$http({
		...
		if(json.gongsidianhua!=''&&json.gongsidianhua){
	...
	this.ruleForm.gongzuoneirong = this.ruleForm.gongzuoneirong.replace(reg,'../../../ssm8mcay/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
