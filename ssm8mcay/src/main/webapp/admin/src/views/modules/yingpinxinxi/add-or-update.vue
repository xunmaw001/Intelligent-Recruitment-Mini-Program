    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="个人简历" prop="gerenjianli">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.gerenjianli" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gerenjianli" label="个人简历" prop="gerenjianli">
                    <span v-html="ruleForm.gerenjianli"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.gerenjianli = this.ruleForm.gerenjianli.replace(reg,'../../../ssm8mcay/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
