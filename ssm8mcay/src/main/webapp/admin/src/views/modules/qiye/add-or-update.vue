<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="企业性质" prop="qiyexingzhi">
          <el-select :disabled="ro.qiyexingzhi" v-model="ruleForm.qiyexingzhi" placeholder="请选择企业性质">
            <el-option
                v-for="(item,index) in qiyexingzhiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="企业性质" prop="qiyexingzhi">
	      <el-input v-model="ruleForm.qiyexingzhi"
                placeholder="企业性质" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="经营内容" prop="jingyingneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jingyingneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jingyingneirong" label="经营内容" prop="jingyingneirong">
                    <span v-html="ruleForm.jingyingneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jingyingneirong = this.ruleForm.jingyingneirong.replace(reg,'../../../ssm8mcay/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
