  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='yonghu'"  label="学历" prop="xueli">
          <el-select v-model="ruleForm.xueli"  placeholder="请选择学历">
            <el-option
                v-for="(item,index) in yonghuxueliOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='qiye'"  label="企业性质" prop="qiyexingzhi">
          <el-select v-model="ruleForm.qiyexingzhi"  placeholder="请选择企业性质">
            <el-option
                v-for="(item,index) in qiyeqiyexingzhiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='qiye'"  label="公司电话" prop="gongsidianhua">
          <el-input v-model="ruleForm.gongsidianhua"               placeholder="公司电话" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='qiye'"  label="联系方式" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi"               placeholder="联系方式" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  mounted() {
    ...
    this.yonghuxueliOptions = "大专,本科,研究生".split(',')
    this.qiyeqiyexingzhiOptions = "外资,中外合资,国有企业,私人企业".split(',')
  },
  methods: {
    ...
    onUpdateHandler() {
      if( 'yonghu' ==this.flag && this.ruleForm.yonghuzhanghao&&(!isMobile(this.ruleForm.yonghuzhanghao))){
        this.$message.error(`用户账号应输入手机格式`);
        return
      }
      ...
      if( 'yonghu' ==this.flag && this.ruleForm.clicknum&&(!isIntNumer(this.ruleForm.clicknum))){
      ...
      if( 'qiye' ==this.flag && this.ruleForm.gongsidianhua&&(!isPhone(this.ruleForm.gongsidianhua))){
        this.$message.error(`公司电话应输入电话格式`);
        return
      }
